...
const SignupModal = ({ show, handleClose }) => {
    ...
    const handleAllCheckboxChange = (e) => {
        ...
        // 모든 체크박스 상태를 "전체 동의" 체크박스의 상태에 맞추어 업데이트
    ...
    const handleCheckboxChange = (setter) => (e) => {
        ...
        // 모든 체크박스가 체크되었는지 확인 후 "전체 동의" 체크박스 상태 업데이트
        if (
            ...
            <Modal.Body>
                ...
                <div className="form-check" style={{ marginLeft: '0.5rem' }}>
                    ...
                    <label 
                        ...
                        htmlFor="checkAll"
                        style={{ marginTop: '0.2rem', marginLeft: '0.5rem', fontSize: '1.125rem', fontFamily: 'Pretendard', fontStyle: 'normal', fontWeight: '600', lineHeight: '121.2%' }}
                    >
